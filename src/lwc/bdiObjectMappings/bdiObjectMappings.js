...
export default class bdiObjectMappings extends LightningElement {
    ...
    */
    retrieveObjectMappings() {
        ...
        getObjectMappings()
            .then((data) => {
                console.log('Object Mappings: ', this.log(data));
    ...
    */
    retrieveObjectOptions() {
        getObjectOptions()
            .then(result => {
                console.log('In the then for refreshObjectOptions result is:');
                console.log(result);
    ...
    */
    handleOpenModal() {
        if (this.displayObjectMappings) {
            ...
            { objectMapping: this.objectMapping, row: undefined });
        }
    }
